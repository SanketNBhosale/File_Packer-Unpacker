		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			if(ae.getSource()==SUBMIT)
			{
				if(Validate(value1,value2) == false)
				{
					text1.setText("");
					text2.setText("");
					JOptionPane.showMessageDialog(this, "Short Username","FilePackerUnpacker" ,JOptionPane.ERROR_MESSAGE);
				}
				...
				else
				{
					...
					if(attemp == 0)
					{
						JOptionPane.showMessageDialog(this, "Number of attempts finished","FilePackerUnpacker",JOptionPane.ERROR_MESSAGE);
						this.dispose();
						System.exit(0);
					}
